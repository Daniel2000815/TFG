...
\newcolumntype{M}{>{$\displaystyle}X<{$}} % mathematics column
...
\newcommand{\miTitulo}{Visualización de superficies en 3D\xspace}
\newcommand{\miSubtitulo}{Representación por \textit{raytracing} de superficies definidas por funciones distancia con signo y conversión de superficies implícitas y paramétricas usando bases de Gröbner \xspace}
\newcommand{\miTitle}{Visualization of 3D surfaces}
\newcommand{\miSubtitle}{\textit{Raytracing} representation of surfaces defined by signed distance functions and conversion of implicit and parametric surfaces using Gröbner bases }
...
\input{Plantilla-TFG-master/preliminares/abstract}
\input{Plantilla-TFG-master/preliminares/originalidad}
\input{Plantilla-TFG-master/preliminares/biblioteca}
% \input{preliminares/agradecimientos}            % Opcional

% \input{Plantilla-TFG-master/preliminares/tutor}
...
\input{Plantilla-TFG-master/preliminares/estadoArte}
...
% \input{apendices/operacionesSDF}
% \input{apendices/comparacionEscenas}
