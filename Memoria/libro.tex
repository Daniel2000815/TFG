...
\newcommand{\miTitulo}{Visualización de superficies definidas por funciones distancia con signo mediante \textit{raytracing} y conversión de superficies implícitas y paramétricas usando bases de Gröbner \xspace}
