...
\newcommand{\miTutor}{
  Carlos Ureña Almagro \\ \emph{Lenguajes y Sistemas Informáticos} 

  % Añadir tantos tutores como sea necesario. 

  \medskip
  Pedro Abelardo García Sánchez \\ \emph{Álgebra}
}
...
\input{capitulos/1_SDF}
% \input{capitulos/capitulo01}
% Añadir tantos capítulos como sea necesario

\cleardoublepage
% \part{Segunda parte}
\chapter{Implicitación de ecuaciones paramétricas}
\input{capitulos/2_Implicitacion}
