    ...
    \begin{minipage}{0.47\textwidth}
        \begin{algorithm}[H]
            ...
            \For{cada primitiva $P$ en el modelo}{
                $S\gets $ píxeles cubiertos por $P$
