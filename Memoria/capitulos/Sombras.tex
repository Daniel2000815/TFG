\subsection{Sombras}\label{sec:sombras}
...
\begin{enumerate}
    ...
    % El valor de la distancia actual recorrida en el rayo $d$ contiene esta información en el 
    
    % La cantidad de luz que permitiremos que reciba será inversamente proporcional a la distancia del obstáculo que se interpone directamente entre la luz y el punto, pues tiene sentido que cuanto más cerca se encuentre el obstáculo del punto menos luz le deje recibir. Dado que el origen del rayo es  Esta cantidad deberá ser mayor cuanto menos haya faltado para perder la intersección, creando un difuminado en el borde:
    \begin{equation*}
        sombra \propto sdf.
    \end{equation*}
    ...
    % Podemos conseguir esto haciendo que $sombra$ sea proporcional a la evaluación de la SDF en el punto actual del rayo:
    \begin{equation*}
