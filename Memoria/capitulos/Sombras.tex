...
\begin{itemize}
    ...
    \begin{equation*}
        sombra \propto sdf,
    \end{equation*}
    \item Cuando un punto sea alcanzado por la luz pero haya estado muy cerca de ser obstruido dejaremos que refleje solo una fracción de la luz total. Esta cantidad deberá ser mayor cuanto menos haya faltado para perder la intersección, creando un difuminado en el borde. Por tanto
    \begin{equation*}
...
\begin{figure}[ht!]
   ...
   \begin{algorithm}[H]
        \caption{CalcularSombras}
            \KwData{punto $p_0$, dirección de luz $l_i$, tamaño de luz $k$}
            \KwResult{Valor entre $0$ y $1$ representando la cantidad de sombra recibida en $p$}
            $sombra \gets 1$
