\subsection{Oclusión ambiental}\label{sec:ao}
...
\begin{figure}
    ...
    \begin{algorithm}[H]
        \caption{CalcularAO}
            ...
            \KwResult{factor de oclusión ambiental en el rango $[0,1]$}
            $ao \gets 1$
    ...
    \begin{algorithm}[H]
        \caption{DibujarSupercicie}\label{alg:fsFinal}
            \KwData{punto $p$, dirección del rayo $v$}
