...
\begin{proposicion}[Operaciones Booleanas]\label{p:boolean}
...
Pasamos ahora a estudiar otro tipo de operaciones, que nos resultarán útiles para generar nuevas formas a partir de un único SDF. 

\begin{proposicion}[Operaciones afines]\label{p:afines}
...
\begin{proposicion}[Operaciones Deformantes]
    Sea $A$ una isosuperficie. Definimos los SDF para las operaciones:
    \begin{itemize}
...
\begin{proposicion}[Operadores de Posicionamiento]\label{p:posicionamiento}
    Sea $A$ una isosuperficie. Definimos los SDF para las operaciones:
    \begin{itemize}
